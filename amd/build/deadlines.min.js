define(['core/templates', 'core/str', 'core/notification', 'core/ajax', 'core_form/modalform'], function(TemplatesModule, StrModule, NotificationModule, AjaxModule, ModalFormModule) {
'use strict';

// Interop: core/templates, core/notification, core/ajax and core_form/modalform are authored with
// default exports, core/str with named ones. Tolerating both shapes keeps this working either side
// of a grunt rebuild. This file is the AMD form of amd/src/deadlines.js and must be regenerated
// whenever the source changes.
var Templates = TemplatesModule.default || TemplatesModule;
var Notification = NotificationModule.default || NotificationModule;
var Ajax = AjaxModule.default || AjaxModule;
var ModalForm = ModalFormModule.default || ModalFormModule;
var getString = StrModule.getString || StrModule.get_string;
